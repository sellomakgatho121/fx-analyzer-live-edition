...
export default function CandlestickChartEnhanced({
  ...
  useEffect(() => {
    ...
    // Initial markers (lightweight-charts v5: markers are chart-level)
    chart.addSeriesMarkers(candleSeries, tradesToMarkers(trades));
  ...
  useEffect(() => {
    if (candleSeriesRef.current) {
      ...
      chartRef.current?.addSeriesMarkers(candleSeriesRef.current, allMarkers);
    }
